...
import {
  Building2, Search, FileText, AlertTriangle, X,
} from "lucide-react";
...
function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="text-sm font-semibold text-gray-700">No clients assigned to you</p>
      <p className="text-xs text-gray-400 mt-1 max-w-xs">
        You only see clients you&apos;ve been given access to. Contact your admin or manager to get assigned to a client.
      </p>
    </div>
  );
}
